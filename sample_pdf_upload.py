...
input_file = "tygz-001.pdf" #@param {type:"string"}
# output_dir = "/content/drive/MyDrive/ndl_ocr/output/pdf_url" #@param {type:"string"}
output_dir = "aaa/content/drive/MyDrive/ndl_ocr/output/pdf_upload" #@param {type:"string"}
...
ins = Util.pdfFromLocal(input_file, output_dir, process, ruby)